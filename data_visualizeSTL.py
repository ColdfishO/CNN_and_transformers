...
# -----------------------------
ckpt_dirs = {
    "convnext": "checkpoints/convnextSTL_checkpoints",
    "googlenet": "checkpoints/googlenetSTL_checkpoints",
    "resnet": "checkpoints/resnetSTL_checkpoints",
    "swint": "checkpoints/swintSTL_checkpoints",
    "vitSmall": "checkpoints/vitSmallSTL_checkpoints",
    "deitSmall": "checkpoints/deitSmallSTL_checkpoints",
}

num_epochs = 200
output_dir = "./data_visualisation/models_compare_stl10"
...
for key in metric_keys:
    ...
    plot_metric_compare(
        ...
        metric_key=key,
        y_label=y_label,
        title=f"{y_label} over Epochs (STL10 Model Comparison)"
    )
...
for model, df in dfs.items():
    ...
    for epoch in subset_epochs:
        ...
        plt.title(
            f"{model.upper()} STL10 Confusion Matrix - Epoch {epoch}"
        )
