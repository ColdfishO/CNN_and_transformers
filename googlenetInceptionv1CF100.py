...
class HierarchicalGoogleNet(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.head_coarse = nn.Linear(self.feature_dim, 20)
        self.head_fine = nn.Linear(self.feature_dim, 100)
...
model = HierarchicalGoogleNet().to(device)
...
ckpt_dir = "checkpoints/googlenet100_checkpoints"
