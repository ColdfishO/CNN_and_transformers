...
model = SwinTransformer(img_size=96, patch_size=4, window_size=6, in_chans=3, num_classes=10, embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24]).to(device)
...
ckpt_dir = "checkpoints/swintSTL_checkpoints"
