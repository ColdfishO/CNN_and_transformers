...
teacher_ckpt = torch.load("checkpoints/resnetSTL_checkpoints/checkpoint_epoch164.pth")
...
model = DeiTSmallCIFAR(img_size=96, patch_size=8, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4.0, num_classes=10).to(device)
...
ckpt_dir = "checkpoints/deitSmallSTL_checkpoints"
